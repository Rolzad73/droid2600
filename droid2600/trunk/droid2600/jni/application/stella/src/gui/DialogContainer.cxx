...
//
// $Id: DialogContainer.cxx,v 1.1.1.1 2010-10-26 03:44:58 cvs Exp $
//============================================================================
...
void DialogContainer::handleKeyEvent(int ascii, int key, int mod, uInt8 state)
{
  ...
  #ifdef ANDROID
  // android devices can ignore direction keys in favor of the touch screen
  //__android_log_print(ANDROID_LOG_INFO, "LauncherDialog", "keycode=%i", keycode);
  if (key == 273
        || key == 274
        || key == 275
        || key == 276) {
