...
//
// $Id: AboutDialog.cxx,v 1.1.1.1 2010-10-26 03:44:58 cvs Exp $
//
...
#define ADD_ALINE ADD_ATEXT("")
  ...
  switch(page)
  {
    case 1:
#ifdef ANDROID
      title = string("Droid2600 1.0");
      ADD_ATEXT(string("\\CAn Android port of the Stella multi-platform"));
      ADD_ATEXT("\\CAtari 2600 VCS emulator. Also partially based");
      ADD_ATEXT("\\Con the following Android/SDL ports:");
      ADD_ATEXT("http://gitorious.org/0xdroid/external_libsdl-12");
      ADD_ATEXT("http://github.com/pelya/commandergenius/archives/sdl_android");
#else
      title = string("Stella ") + STELLA_VERSION;
      ADD_ATEXT("\\CA multi-platform Atari 2600 VCS emulator");
#endif
      ADD_ALINE;
      ADD_ATEXT("\\CStella is Copyright 1995-2010 The Stella Team");
      break;
