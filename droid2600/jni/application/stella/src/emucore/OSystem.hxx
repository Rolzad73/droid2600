...
//
// $Id: OSystem.hxx,v 1.2 2010-12-08 16:48:05 cvs Exp $
//============================================================================
...
/**
  ...
  @version $Id: OSystem.hxx,v 1.2 2010-12-08 16:48:05 cvs Exp $
*/
class OSystem
{
...
#ifdef ANDROID
    /**
      Set the keepAscpectRatio attribute 
    */
    void setKeepAspectRatio(int val);
#endif
...
#ifdef ANDROID
    // Indicates whether we should preserve the aspect ratio
    int keepAspectRatio;
#endif
