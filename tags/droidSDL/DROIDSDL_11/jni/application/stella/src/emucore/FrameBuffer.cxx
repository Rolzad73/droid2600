...
//
// $Id: FrameBuffer.cxx,v 1.1.1.1 2010-10-26 03:44:58 cvs Exp $
//============================================================================
...
void FrameBuffer::update()
{
  ...
  switch(myOSystem->eventHandler().state())
  {
    ...
    {
#ifdef ANDROID_PROFILE
    tslib::Profile::getInstance()->startObservation("FrameBuffer::update (emulate)");
#endif
...
#ifdef ANDROID_PROFILE
    tslib::Profile::getInstance()->stopObservation("FrameBuffer::update (emulate)");
#endif

      // And update the screen
#ifdef ANDROID_PROFILE
    tslib::Profile::getInstance()->startObservation("FrameBuffer::update (drawTIA)");
#endif
      drawTIA(myRedrawEntireFrame);
#ifdef ANDROID_PROFILE
    tslib::Profile::getInstance()->stopObservation("FrameBuffer::update (drawTIA)");
#endif
