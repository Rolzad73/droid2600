...
//
// $Id: FrameBufferSoft.cxx,v 1.2 2010-12-11 05:42:56 cvs Exp $
//============================================================================
...
#ifdef ANDROID
    __android_log_print(ANDROID_LOG_INFO, "FrameBufferSoft::setVidMode",
        "ERROR: Unable to open SDL window: %s", SDL_GetError()); 
#endif
...
#ifdef ANDROID
  if (mode.image_x < mode.image_y) {
    // portrait mode, we do not want to center
    myBaseOffset = ((mode.image_y/8)*myPitch) + mode.image_x;
  }
  else {
...
{
#ifdef ANDROID_PROFILE
    tslib::Profile::getInstance()->startObservation("FrameBufferSoft::postFrameUpdate");
#endif
...
//myRectList->print(myScreen->w, myScreen->h);
  ...
  myRectList->start();
#ifdef ANDROID_PROFILE
    tslib::Profile::getInstance()->stopObservation("FrameBufferSoft::postFrameUpdate");
#endif
}
