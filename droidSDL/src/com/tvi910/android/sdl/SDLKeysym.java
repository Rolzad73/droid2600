...
/**
 * SDL 1.2 keycodes. These mirror the enum found in sdl/incoude/SDL_keysym.h
 */
public class SDLKeysym {
    ...
    /* NOT PART OF SDL_keysym.h -Trent */
    public static final int SDLK_A          = 65;
    public static final int SDLK_B          = 66;
    public static final int SDLK_C          = 67;
    public static final int SDLK_D          = 68;
    public static final int SDLK_E          = 69;
    public static final int SDLK_F          = 70;
    public static final int SDLK_G          = 71;
    public static final int SDLK_H          = 72;
    public static final int SDLK_I          = 73;
    public static final int SDLK_J          = 74;
    public static final int SDLK_K          = 75;
    public static final int SDLK_L          = 76;
    public static final int SDLK_M          = 77;
    public static final int SDLK_N          = 78;
    public static final int SDLK_O          = 79;
    public static final int SDLK_P          = 80;
    public static final int SDLK_Q          = 81;
    public static final int SDLK_R          = 82;
    public static final int SDLK_S          = 83;
    public static final int SDLK_T          = 84;
    public static final int SDLK_U          = 85;
    public static final int SDLK_V          = 86;
    public static final int SDLK_W          = 87;
    public static final int SDLK_X          = 88;
    public static final int SDLK_Y          = 89;
    public static final int SDLK_Z          = 90;
